...
INSERT INTO streaks(user_id, current_streak, last_check_in, streak_type) VALUES
    ...
    (5, 20, SUBDATE(NOW(), INTERVAL 1 DAY), 'daily'),
    (6, 1, SUBDATE(NOW(), INTERVAL 1 DAY), 'daily'),
    (7, 1, SUBDATE(NOW(), INTERVAL 1 DAY), 'daily'),
    (8, 1, SUBDATE(NOW(), INTERVAL 1 DAY), 'daily'),
    (9, 1, SUBDATE(NOW(), INTERVAL 1 DAY), 'daily'),
    (10, 1, SUBDATE(NOW(), INTERVAL 1 DAY), 'daily'),
    (11, 1, SUBDATE(NOW(), INTERVAL 1 DAY), 'daily'),
    (12, 1, SUBDATE(NOW(), INTERVAL 1 DAY), 'daily'),
    (1, 3, SUBDATE(NOW(), INTERVAL 1 YEAR), 'birthday'),
    (2, 2, SUBDATE(NOW(), INTERVAL 366 DAY), 'birthday'),
